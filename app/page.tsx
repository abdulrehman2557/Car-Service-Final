...
export default function Home() {
  ...
  const services = [
  { icon: Wrench, label: language === "en" ? "Plastic Parts Repair" : "Frontrute" },
  { icon: Zap, label: language === "en" ? "Stone Chip Repair" : "Steinsprutreparasjon" },
  { icon: Droplet, label: language === "en" ? "Polishing" : "Polering" },
  { icon: CheckCircle, label: language === "en" ? "Paint Protection" : "Lakkbeskyttelse" },
];
              ...
              <div className="space-y-3 sm:space-y-4 md:space-y-6 animate-slide-up" style={{ animationDelay: "0.2s" }}>
                ...
                <div className="bg-card rounded-lg p-3 sm:p-4 md:p-6 border border-border hover:shadow-lg transition">
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 sm:gap-2 md:gap-3">
                    ...
                    <li className="flex items-center gap-2 text-xs sm:text-xs md:text-sm text-muted-foreground">
                      <span className="w-1.5 h-1.5 bg-primary rounded-full flex-shrink-0"></span>
                      {language === "en" ? "Bodywork Restoration" : "Karosserirestaurering"}
                    </li>
                   
                    
                    <li className="flex items-center gap-2 text-xs sm:text-xs md:text-sm text-muted-foreground">
                      <span className="w-1.5 h-1.5 bg-primary rounded-full flex-shrink-0"></span>
                      {language === "en" ? "Wheel & Rim Service" : "Hjul- og Felgservice"}
                    </li>
                    <li className="flex items-center gap-2 text-xs sm:text-xs md:text-sm text-muted-foreground">
                      <span className="w-1.5 h-1.5 bg-primary rounded-full flex-shrink-0"></span>
                      {language === "en" ? "Premium Finishes" : "Premium Sluttbehandlinger"}
                    </li>
                  </ul>
                </div>
