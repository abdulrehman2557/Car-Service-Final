        ...
        <section className="py-16 md:py-24 bg-card border-t border-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-foreground">
              {language === "en" ? "Our Expert Team" : "Vårt Ekspertteam"}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {/* Team Member 1 */}
              <div className="text-center bg-background p-8 rounded-lg border border-border hover:shadow-lg transition">
                <img
                  src="/images/team-member-1.jpg"
                  alt="Expert Mechanic 1"
                  className="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-primary"
                />
                <h3 className="text-lg font-semibold text-foreground mb-2">
                  {language === "en" ? "Expert Mechanic 1" : "Ekspertmekaniker 1"}
                </h3>
                <p className="text-sm text-muted-foreground mb-3">
                  {language === "en"
                    ? "Certified professional with extensive experience in automotive repair and maintenance"
                    : "Sertifisert fagperson med omfattende erfaring innen bilreparasjon og vedlikehold"}
                </p>
                <p className="text-xs text-primary font-semibold">
                  {language === "en" ? "10+ Years Experience" : "10+ År Erfaring"}
                </p>
              </div>
              ...
              <div className="text-center bg-background p-8 rounded-lg border border-border hover:shadow-lg transition">
                <img
                  ...
                  alt="Expert Mechanic 2"
                  className="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-primary"
                />
                <h3 className="text-lg font-semibold text-foreground mb-2">
                  {language === "en" ? "Expert Mechanic 2" : "Ekspertmekaniker 2"}
                </h3>
                <p className="text-sm text-muted-foreground mb-3">
                  {language === "en"
                    ? "Certified professional with extensive experience in automotive repair and maintenance"
              ...
              <div className="text-center bg-background p-8 rounded-lg border border-border hover:shadow-lg transition">
                <img
                  ...
                  alt="Expert Mechanic 3"
                  className="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-primary"
                />
                <h3 className="text-lg font-semibold text-foreground mb-2">
                  {language === "en" ? "Expert Mechanic 3" : "Ekspertmekaniker 3"}
                </h3>
                <p className="text-sm text-muted-foreground mb-3">
                  {language === "en"
                    ? "Certified professional with extensive experience in automotive repair and maintenance"
              ...
              {/* Team Manager - IOANNIS FARKONAS */}
              <div className="text-center bg-gradient-to-br from-primary/10 to-accent/10 p-8 rounded-lg border-2 border-primary hover:shadow-lg transition">
                <img
                  src="/images/ioannis-farkonas.jpg"
                  alt="IOANNIS FARKONAS - Team Manager"
                  className="w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-primary"
                />
                <h3 className="text-lg font-semibold text-primary mb-2">IOANNIS FARKONAS</h3>
                <p className="text-sm font-semibold text-foreground mb-2">
                  {language === "en" ? "Expert Team Manager" : "Ekspertteam Manager"}
                </p>
                <p className="text-sm text-muted-foreground mb-3">
                  {language === "en"
                    ? "Senior specialist in automotive paint, bodywork, and lacquer services. Expert in car restoration and professional finishing techniques."
                    : "Seniorspesialist innen automotiv maling, karosseri og lakktjenester. Ekspert innen bilrestaurering og profesjonelle finishingteknikker."}
                </p>
                <p className="text-xs text-primary font-semibold">
                  {language === "en" ? "Specialist Manager" : "Spesialistleder"}
                </p>
              </div>
            </div>
          </div>
